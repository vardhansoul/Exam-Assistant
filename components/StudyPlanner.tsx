...
import { AppView, type PerformanceSummary, type StudyPlan } from '../types';
...
const StudyPlanner: React.FC<StudyPlannerProps> = ({ setView, setPreselectedTopic, selectionPath, availableTopics, language, isOnline }) => {
    ...
    const performanceData = useMemo(() => {
        ...
        return { totalQuizzes, averageScore, masteredTopics, weakTopics };
    }, []);
            ...
            <Card>
                ...
                {!studyPlan && (
                    <div className="mt-8 text-center">
                        <Button onClick={handleGeneratePlan} disabled={isLoading || !isOnline} className="!py-3 px-8">
